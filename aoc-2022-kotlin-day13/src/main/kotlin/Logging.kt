...
fun <T> T.logTrace(prefix: String = "", logger: KLogger = LOGGER): T {
    this.log(prefix, logger::trace)
    return this
}

fun <T, F : () -> T> F.logTrace(prefix: String = "", logger: KLogger = LOGGER): F {
    this.log(prefix, logger::trace)
    return this
}

fun <T> T.logDebug(prefix: String = "", logger: KLogger = LOGGER): T {
    this.log(prefix, logger::debug)
    return this
}

fun <T, F : () -> T> F.logDebug(prefix: String = "", logger: KLogger = LOGGER): F {
    this.log(prefix, logger::debug)
    return this
}

fun <T> T.logInfo(prefix: String = "", logger: KLogger = LOGGER): T {
    this.log(prefix, logger::info)
    return this
}

fun <T, F : () -> T> F.logInfo(prefix: String = "", logger: KLogger = LOGGER): F {
    this.log(prefix, logger::info)
    return this
}
